...
void cadastra_dance(dance *d, int tam) {
	...
	for(i = 0; i < tam; i++, d++) {
		...
		if(i < 3) {
			d->modalidade = 'B';
			switch(i) {
				case 0: d->turno = 'M'; break;
				case 1: d->turno = 'T'; break;
				case 2: d->turno = 'N'; break;
			}
			
		} else {
			d->modalidade = 'S';
			switch(i) { 
				case 3: d->turno = 'M'; break;
				case 4: d->turno = 'T'; break;
				case 5: d->turno = 'N'; break;
			}
		}
		
		switch(d->turno) {
			case 'M': d->valor = 300.00; break;
			case 'T': d->valor = 250.00; break;
			case 'N': d->valor = 350.00; break;
		}
	}
}//cadastra_dance
void cadastra_aluno(aluno *a, dance *d) {
