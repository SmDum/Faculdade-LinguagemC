...
void aloca_quarto(quarto **p_quarto, int quant_quarto);
...
main()
{
    quarto *pq = NULL;
    hospede *ph = NULL;
    int op, cont = 0, pos, quant=15;

    aloca_quarto(&pq, quant);
    cadastro_quarto(pq, quant);
    do
    {
        system("cls");
        printf("\n[1]Check-in\n[2]Check-out\n[3]Mostra Quarto\n[4]Mostra Hospede\n[5]Fim\nOpcao: ");
        ...
        case 1:
            ...
            cadastro_hospede(ph + pos, pq, quant);
            break;
        case 2:
            check_out(ph, cont, pq);
            break;
        case 3:
            mostra_quarto(pq, quant);
            break;
        case 4:
